    ...
    dashboardBody(
        tabItems(
            ...
            tabItem(tabName = "Home",
                    ...
                    fluidRow(box(h3("About the Application"))),
                    
                    fluidRow(box("The objective of this application is two-fold: 1) give a basic introduction into
                                        traditional and alternative investments; 2) help the user get a better 
                                        understanding of hedge funds.")),
                    fluidRow(box("Data tab breaks down investment 
                    ...
                    fluidRow(box("Similar to ingredients in a recipe, hedge funds can also be broken down into building blocks - 
                      risk factors. Portfolio Decomposition tab determines traditional and alternative 
                      investment strategies the portfolio is composed of and percentage allocations to them. 
                      Pie chart illustrates percentages of portfolio risk explained by each strategy and the remaining (idiosyncratic) 
            ...
            tabItem(tabName = "Portfolio_Decomposition",
                    ...
                    fluidPage(
                                ...
                                box(plotOutput("piechart4"),
                                plotOutput("barchart4"),width=4)
                    ) 
            ),
            # About tab ####        
            tabItem(tabName = "About", 
                    fluidRow(column(3,h3("Bio Sketch"))),
                    #fluidRow(column(1, div(img(src="photo.png", height=120))),
                    fluidRow(column(6, 
                           div(
